...
function XNGInput(props: IXNGInput) {
  ...
  const SX = props.numberArrows
    ...
    : {...STYLE} ;
  const ABPAD = SIZE === "large" ? ".4rem" : SIZE === "default" ? ".2rem" : SIZE === "small" ? ".1rem" : 0;

  return (
    <Box sx={{ position: "relative" }}>
      <Box sx={{ ".MuiOutlinedInput-input": { width:WIDTH, height: HEIGHT, paddingY: 0, paddingX: getSizing(1) } }}>
        <TextField
