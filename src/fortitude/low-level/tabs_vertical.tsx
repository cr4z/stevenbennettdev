...
function VerticalTabs(props: {
  ...
  const COLOR_BGHOVER: string = props.overrideColor ? props.overrideColor.bghover : palette.contrasts[4];
  const COLOR_TEXT: string = props.overrideColor ? props.overrideColor.text : "";
  const COLOR_BORDER: string = props.overrideColor ? props.overrideColor.border : palette.contrasts[3];
